...
?>
<style>
div.answer .correct{background:#f1fbf5; width:60%; border-radius:15px; padding-top:5px;}
div.answer .correct input[type=radio]:checked {content:url(pix/icons_ok.png);}
</style>
<?php
//end@dp
