...
class core_question_renderer extends plugin_renderer_base {
    ...
    public function question(question_attempt $qa, qbehaviour_renderer $behaviouroutput,
        ...
        /*$output .= html_writer::tag('div',
                ...
                array('class' => 'info'));
		$output .= html_writer::start_tag('div', array('class' => 'info', 'style' => 'border:1px solid red;'));
		
		$output .= html_writer::end_tag('div');*/
		$output .= html_writer::tag('div',
                $this->dpinfo($qa, $behaviouroutput, $qtoutput, $options, $number),
                array('class' => 'info'));
		//end@dp
	...
	protected function dpinfo(question_attempt $qa, qbehaviour_renderer $behaviouroutput,
            qtype_renderer $qtoutput, question_display_options $options, $number) {
		$output = '';
